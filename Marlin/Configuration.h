...
#define STRING_CONFIG_H_AUTHOR "(Dano, DanoX301BugFix)" // Who made the changes.
#define CUSTOM_VERSION_FILE Dano_X301.h // Path from the root directory (no quotes)
...
#define CUSTOM_MACHINE_NAME "DanoX301"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "af986a85-27d4-4c5d-b7b0-3f3fbc350f84"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  29.3875
    #define DEFAULT_Ki   2.2497
    #define DEFAULT_Kd  95.9721
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 107.6790
  #define DEFAULT_bedKi 21.5143
  #define DEFAULT_bedKd 359.2888
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.03, 80.17, 1595.38, 427.58 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 25, 10000 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3500, 3500, 25, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -3.3 }
...
#define LCD_FEEDBACK_FREQUENCY_HZ 262
